...
<body>
  ...
  <section class="nav">
    <div class="w">
      ...
      <a href="contact-us.jsp" class="active"><i><img src="images/icon6.png" alt=""></i><p>联系我们</p></a>
    </div>
  </section>
  <section class="env-content w">
    <div class="right-container">
      <div class="r_navigator clearfix">
        <div class="fl">
          <p>CONTACT US</p>
          <h4>联系我们</h4>
        </div>
        <div class="fr">
          ...
          <span class="cur"><a href="javascript:;">联系我们</a></span>
        </div>
      </div>
      <div class="r_secNav pic3">
        <ul class="clearfix">
          <li class="active"><a href="javascript:;">机构职能</a></li>
          <li><a href="javascript:;">局长邮箱</a></li>
          <li><a href="javascript:;">联系方式</a></li>
        </ul>
      </div>
      <div class="r_con">
      	<div id="jigou"></div>
      	<div id="juzhang" style="display: none;"></div>
      	<div id="lianxi" style="display: none;"></div>
      </div>
    </div>
  </section>
  <script type="text/javascript">
  	$(".pic3 .clearfix li").click(function(event) {
  		/* Act on the event */
  		$(this).addClass('active').siblings().removeClass('active');
  		var hh = $(this).index();
  		$(".r_con>div").eq(hh).show().siblings().hide();
  	});
  </script>
	<footer>
		<section class="w tc">
  ...
  $(function(){
	  ...
	  $.ajax({
			url:"/front/getDataLianXiUs.action",
			type:"POST",
			data:{},
			dataType:"json",
			success: function(res) {
				...
				var map2 = res.data2;
				var map3 = res.data3;
				$("#jigou").html(map1[0].content);
				$("#juzhang").html(map2[0].content);
				$("#lianxi").html(map3[0].content);
			},error:function(){
				alert("系统繁忙，请稍后再试...");
			}
		});
