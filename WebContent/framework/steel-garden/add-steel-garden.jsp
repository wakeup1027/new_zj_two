...
function submitsave(){
	...
	if($("#savtype").val()=="edit"){
		$.ajax({
			url:"/framework/admin/updGangTieYuanQu.action",
			type:"POST",
			data:{
				"title":title,
				"content":conne,
		...
		$.ajax({
			url:"/framework/admin/addGangTieYuanQu.action",
			type:"POST",
			data:{
				"title":title,
				"content":conne
...
if(ss!="0"){
	$.ajax({
		url:"/framework/admin/getGangTieYuanQu.action",
		type:"POST",
		data:{
			"daid":ss
		},
