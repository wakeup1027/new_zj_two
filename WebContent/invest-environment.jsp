...
<body>
  ...
  <section class="nav">
    <div class="w">
      ...
      <a href="invest-environment.jsp" class="active"><i><img src="images/icon3.png" alt=""></i><p>投资环境</p></a>
  ...
  <section class="second-nav">
    <ul class="w">
      <li class="active"><a href="invest-environment.jsp">了解我们</a></li>
  ...
  <section class="env-content w">
    <div class="left-nav">
      ...
      <ul>
        <li class="active"><a href="javascript:;">了解我们</a></li>
        <li><a href="invest-project.jsp">投资项目</a></li>
        <li><a href="invest-guidance.jsp">投资政策</a></li>
        <li><a href="invest-cost.jsp">投资成本</a></li>
        <li><a href="invest-importprise.jsp">重点企业</a></li>
    ...
    <div class="right-container">
      <div class="right-con">
        <div class="r_navigator">
          ...
          <span><a href="invest-environment.html">投资环境</a>&nbsp;>&nbsp;</span>
          <span><a href="javascript:;">了解我们</a></span>
        </div>
        <div class="r_secNav">
          <ul class="clearfix">
        ...
        <div class="r_con">
          	<div id="kaifaquqk">
          		<!-- <div id="kaifaquqk_title"></div> -->
          		<!-- <div id="kaifaquqk_time"></div> -->
          		<div id="kaifaquqk_connet"></div>
          	</div>
          	<div id="youshi" style="display: none;">
          		<!-- <div id="youshi_title"></div>
          		<div id="youshi_time"></div> -->
          		<div id="youshi_connet"></div>
          	</div>
          	<div id="jingji" style="display: none;">
          		<!-- <div id="jingji_title"></div>
          		<div id="jingji_time"></div> -->
          		<div id="jingji_connet"></div>
          	</div>
          	<div id="kaifaqugh" style="display: none;">
          		<!-- <div id="kaifaqugh_title"></div>
          		<div id="kaifaqugh_time"></div> -->
          		<div id="kaifaqugh_connet"></div>
          	</div>
        </div>
        <script type="text/javascript">
        	$(".r_secNav .clearfix li").click(function(event) {
        		/* Act on the event */
        		$(this).addClass('active').siblings().removeClass('active');
        		var index = $(this).index();
        		$(".r_con>div").eq(index).show().siblings().hide();
        	});
        </script>
      </div>
    </div>
  ...
  $(function(){
	  ...
	  $.ajax({
			url:"/front/getDataLiaoJieWoMen.action",
			type:"POST",
			data:{},
			dataType:"json",
			success: function(res) {
				...
				var map3 = res.map3.data;
				var map4 = res.map4.data;
				$("#kaifaquqk_title").text(map1[0].title);
				$("#kaifaquqk_time").text(fotmateDateArray(map1[0].creatime));
				$("#kaifaquqk_connet").html(map1[0].content);
				
				$("#youshi_title").text(map2[0].title);
				$("#youshi_time").text(fotmateDateArray(map2[0].creatime));
				$("#youshi_connet").html(map2[0].content);
				
				$("#jingji_title").text(map3[0].title);
				$("#jingji_time").text(fotmateDateArray(map3[0].creatime));
				$("#jingji_connet").html(map3[0].content);
				
				$("#kaifaqugh_title").text(map4[0].title);
				$("#kaifaqugh_time").text(fotmateDateArray(map4[0].creatime));
				$("#kaifaqugh_connet").html(map4[0].content);
			},error:function(){
				alert("系统繁忙，请稍后再试...");
			}
		});
