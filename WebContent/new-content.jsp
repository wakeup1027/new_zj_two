...
<head>
    ...
    <title>新闻中心-投资动态</title>
</head>
<style type="text/css">
#kaifaqugh ul li{line-height:35px; border-bottom:1px dashed #ccc; text-indent: 17px; background: url(../images/hsjt.png) no-repeat 3px 15px; color: #666; cursor: pointer; position: relative;}
#kaifaqugh ul li>span{position:absolute;right:5px;}
...
<body>
  ...
  <section class="nav">
    <div class="w">
      ...
      <a href="new-content.jsp" class="active"><i><img src="images/icon2.png" alt=""></i><p>新闻中心</p></a>
  ...
  <section class="second-nav">
    <ul class="w">
      ...
      <li class="active"><a href="new-media.jsp">新闻媒介</a></li>
    </ul>
  </section>
  <section class="env-content w">
    <div class="left-nav">
      ...
      <ul>
        <li class="active"><a href="javascript:;">投资动态</a></li>
        <li><a href="new-media.jsp">新闻媒介</a></li>
      </ul>
    </div>
    <div class="right-container">
      <div class="right-con">
        <div class="r_navigator">
          ...
          <span><a href="new-content.jsp">新闻中心</a>&nbsp;>&nbsp;</span>
          <span class="cur"><a href="new-content.jsp">投资动态</a></span>
        </div>
  ...
  $(function(){
	  ...
	  var limitpage = 20;
	  $.ajax({
			url:"/front/getDataTouZiDongTai.action",
			type:"POST",
			data:{
				"page":1,
				"limit":limitpage
			...
			success: function(res) {
				...
				for(var i=0; i<ress.length; i++){
					var ss = "<li><a href='details-page.jsp?dataty=1&fdid="+ress[i].id+"' target='_blank'>"+ress[i].title+"</a><span>"+fotmateDateArray(ress[i].creatime)+"</span></li>";
					$("#kaifaqugh ul").append(ss);
				}
