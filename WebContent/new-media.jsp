...
<head>
    ...
    <title>新闻中心-新闻媒介</title>
    <style type="text/css">
      .r_con{margin-top:10px;}
      .r_con>.videoList{width:23%; float:left; margin-top:10px; margin-left:10px;}
      .r_con>.videoList>video{width: 100%;}
      /*分页*/
...
<body>
    ...
    <div class="right-container">
      <div class="right-con">
        <div class="r_navigator">
          ...
          <span class="cur"><a href="new-media.jsp">新闻媒介</a></span>
        </div>
        <div id="boxvideo" class="r_con"></div>
  ...
  $(function(){
	  ...
	  var limitpage = 20;
	  $.ajax({
			url:"/front/getDataXinWenMeiJie.action",
			type:"POST",
			data:{
				"page":1,
				"limit":limitpage
			...
			success: function(res) {
				...
				for(var i=0; i<ress.length; i++){
					var divbox = '<div class="videoList"><a href="details-page.jsp?dataty=2&fdid='+ress[i].id+'" target="_blank"><img src="'+ress[i].fmimg+'" style="cursor:pointer; width:202px; height:113px;"/></a><p>'+ress[i].title+'</p></div>';
					$("#boxvideo").append(divbox);
				}
