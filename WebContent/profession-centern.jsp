...
<body>
  ...
  <section class="nav">
    <div class="w">
      ...
      <a href="profession-garden.jsp" class="active"><i><img src="images/icon5.png" alt=""></i><p>专业园区</p></a>
  ...
  <section class="second-nav">
    <ul class="w">
      ...
      <li class="active"><a href="javascript:;">中央商务区</a></li>
    </ul>
  </section>
    ...
    <div class="right-container">
      <div class="right-con">
        <div class="r_navigator">
          ...
          <span><a href="invest-environment.html">专业园区</a>&nbsp;>&nbsp;</span>
          <span class="cur"><a href="javascript:;">中央商务区</a></span>
        </div>
        <!-- div class="r_secNav">
          <ul class="clearfix">
  ...
  $(function(){
	  ...
	  $.ajax({
			url:"/front/getDataZhongYangShangWu.action",
			type:"POST",
			data:{},
			dataType:"json",
