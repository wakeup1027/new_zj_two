...
<body>
  ...
  <section class="second-nav">
    <ul class="w">
      ...
      <li class="active"><a href="javascript:;">钢铁配套园区</a></li>
    ...
    <div class="right-container">
      <div class="right-con">
        <div class="r_navigator">
          ...
          <span class="cur"><a href="javascript:;">钢铁配套园区</a></span>
        </div>
        <!-- div class="r_secNav">
          <ul class="clearfix">
  ...
  $(function(){
	  ...
	  $.ajax({
			url:"/front/getDataGangTieYuanQu.action",
			type:"POST",
			data:{},
			dataType:"json",
